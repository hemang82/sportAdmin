    ...
    const verifyOtp = (() => {
        ...
        if (timer != '00') {
            ...
            if (otpValue1.current.value == '' || otpValue2.current.value == '' || otpValue3.current.value == '' || otpValue4.current.value == '') {
                ...
                localStorage.setItem('temperary_auth', JSON.stringify(userData));
                ...
                <div className="panel-body">
                    <form className="login_form"  >
                        ...
                        <div className="mb_20 mt-3 mb-3">
                            ...
                            <Button onClick={() => {
                                verifyOtp();
                            }} className="submit_btn w-100 mt-3 btn_color " variant="outline-success" style={{ width: '100%', backgroundColor: '#36AE7C' }}>
                                Verify
                            </Button>
