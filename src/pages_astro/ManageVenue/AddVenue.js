    ...
    return (
        <>
            <div className="container-fluid mw-100">
                ...
                <SubNavbar title={venueData ? 'Edit Venue' : 'Add Venue'} header={'Venue List'} subHeaderOnlyView={venueData ? 'Edit Venue' : 'Add Venue'} />
                                        ...
                                        <div className='row g-3'>
                                            <div className='col-md-6'>
                                                ...
                                                <div className="d-flex justify-content-start mb-4">
                                                    ...
                                                    >
                                                        <i className="ti ti-circle-plus fs-6"></i>
                                                        <span className="ms-2">Add Facilities</span>
                                                    </button>
                                                </div>

                                                {facilitiesFields.map((item, index) => (
                                                    <div className="row mb-3 row" key={item.id}>
                                                            ...
                                                            <div className="col-md-3">
                                                                ...
                                                                <Controller
                                                                    ...
                                                                    render={({ field }) => (
                                                                        <TimePicker
                                                                            {...field}
                                                                            className="form-control custom-datepicker ps-2"
                                                                            format="HH:mm"
