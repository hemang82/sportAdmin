...
import { getUserListThunk, setLoader, updateCustomerList } from '../../Store/slices/MasterSlice';
...
export default function ManageCoustomer() {
    ...
    const { customerList: { data: userList } } = useSelector((state) => state.masterslice);
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                await dispatch(getUserListThunk(request));
            } finally {
    ...
    return (
        <>
            <div className="container-fluid mw-100">
                <SubNavbar title={"User List"} header={'User List'} />
                <div className="widget-content searchable-container list">
                    <div className="card card-body">
                        <div className="row">
                            <div className="col-md-4 col-xl-3">
                                <div className="position-relative">
                                    <input type="text" className="form-control product-search ps-5" id="input-search" placeholder="Search User..."
                    ...
                    <div className="card card-body">
                        <div className="table-responsive">
                            <DataTable
                                ...
                                loading={loading}
                                emptyMessage={<span style={{ textAlign: 'center', display: 'block' }}>No users found.</span>}
                            >
                                <Column
                                    field="id"
                                    header="Id"
                                ...
                                <Column field="phone_number" sortable header="Phone Number" style={{ minWidth: '12rem' }} body={(rowData) => (
                                ...
                                {/* <Column field="email" sortable header="Email" style={{ minWidth: '12rem' }} /> */}
                                <Column field="email" sortable header="Email" style={{ minWidth: '12rem' }} body={(rowData) => (
                            ...
                            <div className=''>
                                <Pagination per_page={userList?.perPage} pageCount={userList?.page_count} onPageChange={onPageChange} page={userList?.currentPage} />
                            </div>
