...
import { getContactUSListThunk, getContactUsListThunk, getListContactUsThunk, setLoader } from '../../Store/slices/MasterSlice';
...
export default function ManageCoustomer() {
    ...
    const { contactList: { data: contactUsList }, } = useSelector((state) => state.masterslice);
    ...
    useEffect(() => {
        ...
        dispatch(getContactUSListThunk(request))
                    ...
                    <div className="card card-body">
                        ...
                        <div className="table-responsive">
                            <DataTable
                                ...
                                loading={loading}
                                emptyMessage={<span style={{ textAlign: 'center', display: 'block' }}>No Contect US found.</span>}
                            >
                                <Column
                                    field="id"
                                    header="Id"
                                ...
                                <Column field="status" header="Action" style={{ minWidth: '8rem' }} body={(rowData) => (
                                    <div className="action-btn">
                                        ...
                                        <Link to={PATHS?.CONTACT_US_DETAILS} state={rowData} className="text-info edit cursor_pointer">
                        ...
                        <div className=''>
                            <Pagination per_page={perPage} pageCount={contactUsList?.total} onPageChange={onPageChange} page={page} />
                        </div>
