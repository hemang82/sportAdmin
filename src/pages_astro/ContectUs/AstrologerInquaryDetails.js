...
const AstrologerInquaryDetails = () => {
    ...
    return (
        <>
            ...
            <div className="container-fluid mw-100">
                ...
                <SubNavbar title={'Astrologer Inquary List'} header={'Astrologer Inquary List'} subHeaderOnlyView={'Astrologer Inquary Details'} />
...
export default AstrologerInquaryDetails;
