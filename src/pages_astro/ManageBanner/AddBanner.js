...
export default function AddCategory() {
    ...
    useEffect(() => {
        if (BannerData) {
            ...
            setValue("banner_image", getFileNameFromUrl(BannerData?.image)); // If image name is stored
        }
    }, [BannerData, setValue]);
    ...
    return (
        <>
            ...
            <div className="container-fluid mw-100">
                ...
                <SubNavbar title={BannerData ? 'Edit Banner' : 'Add Banner'} header={'Banner List'} subHeaderOnlyView={BannerData ? 'Edit Banner' : 'Add Banner'} />
                                                        ...
                                                        <div className="dropzone cursor_pointer custom_dropzone" >
                                                            <label htmlFor={AstroInputTypesEnum.BANNER_IMAGE} className='cursor_pointer'>
                                                                <Controller name={AstroInputTypesEnum.BANNER_IMAGE}
                                                                    ...
                                                                    render={({ field }) => (<>
                                                                        <input type="file" name='banner_image' className="custom-file-input form-control" id={AstroInputTypesEnum.BANNER_IMAGE} accept="image/*" onChange={handleImageChange} style={{ display: 'none' }} />
